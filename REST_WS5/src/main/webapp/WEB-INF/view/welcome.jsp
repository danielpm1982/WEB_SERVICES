	...
	<body>
		...
		<security:authentication property="principal.authorities" var="roles" scope="session" />
       	...
       	<div class="link">
       		...
       		<a href="http://localhost:8080/REST_WS5/api/contactManager/contacts" title="GET all contacts request">http://localhost:8080/REST_WS5/api/contactManager/contacts</a>
       	</div>
       	<security:authorize access="hasRole('ADMIN')">
			<div class="link">
				<p>GET endpoint for truncating the DB and deleting all Provider existing Contacts<br>(if any exists...):</p>
	       		<a href="http://localhost:8080/REST_WS5/api/contactManager/truncateAndClearDB" title="GET clear all contacts and truncate DB">http://localhost:8080/REST_WS5/api/contactManager/truncateAndClearDB</a>
       		</div>
		</security:authorize>
