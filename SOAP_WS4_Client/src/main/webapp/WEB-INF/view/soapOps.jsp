...
<html>
    ...
    <body>
       	<div class="soapOps">
			...
			<p><a href="${pageContext.request.contextPath}/controller/testUpload" title="testUpload">Test Upload</a></p>
			<p><a href="${pageContext.request.contextPath}/controller/testDownload" title="testDownload">Test Download</a></p>
			<p><a href="${pageContext.request.contextPath}/" title="Home">Home</a></p>
		</div>
    </body>
</html>
