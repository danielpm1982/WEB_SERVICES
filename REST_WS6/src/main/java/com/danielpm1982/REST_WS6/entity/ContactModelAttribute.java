...
and at the Persistence @Service beans, when they have to be sent to the DAO using for persistence, using the real 
entities there, not at the view. At Spring forms we can use only one modelAttribute, which receives all form data
and then have this data distributed to the Controller, Persistence Services and DAOs.
*/
