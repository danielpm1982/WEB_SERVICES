	...
	<body>
		...
		<security:authentication property="principal.authorities" var="roles" scope="session" />
       	...
       	<div class="link2">
      		...
      		<a href="${pageContext.request.contextPath}/api/contactManager/contacts" title="GET all contacts request">api/contactManager/contacts</a>
	       	<security:authorize access="hasRole('ADMIN')">
				<p>GET endpoint for truncating the DB and deleting all Provider existing Contacts:</p>
	       		<a href="${pageContext.request.contextPath}/api/contactManager/truncateAndClearDB" title="GET clear all contacts and truncate DB">api/contactManager/truncateAndClearDB</a>
			</security:authorize>
			<br><br>
      		<p>* Other endpoints (POST, PUT and DELETE) can be tested with Postman.</p>
   		</div>
       	<form:form class="buttom" action="${pageContext.request.contextPath}/logout" method="post">
