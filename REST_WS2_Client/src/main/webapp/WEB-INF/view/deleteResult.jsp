...
<html>
    ...
    <body>
       	<div class="mainBody">
			<c:if test="${deleted}">
				<p>DELETE request result (deletePerson) from the endpoint<br>${personsURL}/{id}:</p>
				<p>Person successfully deleted !</p>
			...
			<c:if test="${empty person}">
				<p>DELETE request result (deletePerson) from the endpoint<br>${personsURL}/{id}:</p>
				<p>Registry not found ! Deletion Failed ! NotFoundException thrown/caught !</p>
